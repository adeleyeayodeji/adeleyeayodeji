...
<html class="no-js" lang="en">
    ...
    ?>
        ...
        <meta name="description"
            content="Adeleye Ayodeji is a professional with a broad set of skills in software, web development, speaking among many other God-given talents. Equipped with so ...">
    ...
    <![endif]-->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-8">
                            <div class="logo">
                                <a href="index.php"><img src="img/logo-adeleye-w.png" alt="Adeleye Ayodeji"
                                        style="height: 50px;"></a>
                            </div>
                        </div>
                        <div class="col-md-9 col-4">
                            <ul id="menu_items" class="menu_items">
                                <li class="nav-item">
                                    <a href="#top" class="active menu_item nav-link slide-horizontal"
                                        data-splitting>Home</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#about" class="menu_item nav-link slide-horizontal"
                                        data-splitting>About</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#service" class="menu_item nav-link slide-horizontal"
                                        data-splitting>Service</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#works" class="menu_item nav-link slide-horizontal"
                                        data-splitting>Works</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#github" class="menu_item nav-link slide-horizontal"
                                        data-splitting>GitHub</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#contact" class="menu_item nav-link slide-horizontal"
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    ...
                                    <div class="about_img">
                                        ...
                                        <!--<img class="about_img_2 bottom" src="img/IMG_20200522_121756_834_2.jpg" alt="">-->
                                    </div>
                                    <!-- end about image -->
                                </div>
                                    ...
                                    <div class="about_info">
                                        ...
                                        <p class="about_desc">
                                            <span>I am experienced in application and web development using PHP,
                                                JavaScript, SQL Database services.</span>
                                            <br>
                                            ...
                                            technologies like AJAX Toolkit, JQuery, JavaScript, XML and HTML.
                                        </p>
                                        ...
                                        <ul class="social_links mt-4">
                                            <li><a href="https://www.facebook.com/adeleyeayodeji.code" target="_blank"
                                                    rel='noopener'><span class="ion-social-facebook"></span></a></li>
                                            <li><a href="https://www.google.com/maps/place/Adeleye+Ayodeji/@6.6741407,3.265471,15z/data=!4m5!3m4!1s0x0:0x92f667b3cd4a9b05!8m2!3d6.6741407!4d3.265471"
                                                    target="_blank" rel='noopener'><span
                                                        class="ion-social-google"></span></a></li>
                                            <li><a href="https://twitter.com/adeleyeayodeji_" target="_blank"
                                                    rel='noopener'><span class="ion-social-twitter"></span></a></li>
                                            <li><a href="https://www.instagram.com/adeleyeayodeji.code/" target="_blank"
                                                    rel='noopener'><span
                                                        class="ion-social-instagram-outline"></span></a></li>
                                            <li><a href="https://www.linkedin.com/in/adeleye-ayodeji-69a927158/"
                                                    target="_blank" rel='noopener'><span
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="row works">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 uiux">
                                        <img src="img/logo-pde.webp" class="img-fluid rounded-circle" alt=""
                                            style="height: 120px;">
                                        ...
                                        <div class="row no-guter mt-4 mb-4">
                                            <div class="col">
                                                <a href="https://play.google.com/store/apps/details?id=com.aqskill.learn"
                                                    target="_blank">
                                                    <img src="img/play.png" class="img-fluid" alt="">
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a href="javascript:alert('Under Review');">
                                                    <img src="img/app-store-ipod-touch-apple-apple.jpg"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 uiux">
                                        <div class="work_single_item">
                                            <img class="img-fluid" src="img/AQskill.com.png" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="row works">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 uiux">
                                        <div class="work_single_item">
                                            ...
                                            <div class="work_info">
                                                ...
                                                <p>Hotel and Suit</p>
                                                <a class="link" href="https://betterdaysguesthouse.com/" target="_blank"
                                                    rel='noopener'><span class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- work single item  -->
                                    <div class="col-lg-4 col-md-6 col-sm-6 web">
                                        <div class="work_single_item">
                                            <img class="img-fluid"
                                                src="img/Screenshot_2020-02-04 BSTA Custom Tailor.png" alt="">
                                            <div class="work_info">
                                                <h6 title="BSTA Custom Tailor">BSTA Custom Tailor</h6>
                                                <p>Custom Tailor</p>
                                                <a class="link" href="https://bstatailors.net/" target="_blank"
                                                    rel='noopener'><span class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 branding">
                                        <div class="work_single_item">
                                            <img class="img-fluid"
                                                src="img/Screenshot_2020-02-04 Maxfem Int'l Schools.jpg" alt="">
                                            <div class="work_info">
                                                <h6 title="Maxfem College">Maxfem College</h6>
                                                <p>Result Management</p>
                                                <a class="link" href="https://result.maxfemschools.com/find-result.php"
                                                    target="_blank" rel='noopener'><span
                                                        class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- work single item  -->
                                    <div class="col-lg-4 col-md-6 col-sm-6 web">
                                        <div class="work_single_item">
                                            <img class="img-fluid"
                                                src="img/Screenshot_2020-02-04 Homepage - Dechristies Ruby.png" alt="">
                                            <div class="work_info">
                                                <h6 title="De Christie’s Ruby">De Christie’s Ruby</h6>
                                                <p>SPA and Wellness</p>
                                                <a class="link" href="https://dechristiesruby.com/" target="_blank"
                                                    rel='noopener'><span class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 branding">
                                        <div class="work_single_item">
                                            <img class="img-fluid" src="img/Screenshot_2020-02-04 Phronesis Foods .jpg"
                                                alt="">
                                            <div class="work_info">
                                                <h6 title="Phronesis Foods">Phronesis Foods</h6>
                                                <p>Food processing and Packaging</p>
                                                <a class="link" href="https://phronesisfoods.ng/" target="_blank"
                                                    rel='noopener'><span class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 uiux">
                                        <div class="work_single_item">
                                            <img class="img-fluid"
                                                src="img/Screenshot_2020-02-04 Home - Osho Ademola Joel.png" alt="">
                                            <div class="work_info">
                                                <h6 title="Osho Ademola Joel">Osho Ademola Joel</h6>
                                                <p>Business Consulting & Digital Marketing</p>
                                                <a class="link" href="https://www.oshoademolajoel.com/" target="_blank"
                                                    rel='noopener'><span class="ion-android-expand"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="service_items">
                                    <div class="row" id="loops">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="service_single_item">
                                                ...
                                                <a href="https://github.com/adeleyeayodeji/Ajax-Image-Upload-WIth-Progress-Bar"
                                                    target="_blank" rel='noopener'>
                                                    <h6 style="font-size: 16px;"
                                                        data-hover="Ajax-Image-Upload-WIth-Pr..">
                                                        Ajax-Image-Upload-WIth-Pr..</h6>
                                                </a>
                                                <p>Easily upload your images, files along with a prog..</p>
                                                <a href="https://github.com/adeleyeayodeji/Ajax-Image-Upload-WIth-Progress-Bar/archive/master.zip"
                                                    class="float-left"
                                                    style="border: 1px solid #222;border: 1px solid #222;padding: 5px;margin-top: 20px;color: white;">Download
                                                    <span class="mbri-save text-bold"
                                                        style="color: #ba0d84;margin-left: 8px;"></span></a>
                                                <p
                                                    style="border: 1px solid #222;color: #fff; margin-left: 150px;padding: 5px;text-align: center;margin-top: 20px;">
                                                    Hack</p>
                                            </div>
                                        </div>
                                        <!-- end of service single -->
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="service_single_item"><i class="mbri-github"></i><a
                                                    href="https://github.com/adeleyeayodeji/Basic-PHP-Ecommerce-"
                                                    target="_blank" rel='noopener'>
                                                    <h6 style="font-size: 16px;" data-hover="Basic-PHP-Ecommerce-..">
                                                        Basic-PHP-Ecommerce-..</h6>
                                                </a>
                                                <p>Get started with ecommerce website development fro..</p><a
                                                    href="https://github.com/adeleyeayodeji/Basic-PHP-Ecommerce-/archive/master.zip"
                                                    class="float-left"
                                                    style="border: 1px solid #222;border: 1px solid #222;padding: 5px;margin-top: 20px;color: white;">Download
                                                    <span class="mbri-save text-bold"
                                                        style="color: #ba0d84;margin-left: 8px;"></span></a>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="service_single_item"><i class="mbri-github"></i><a
                                                    href="https://github.com/adeleyeayodeji/codedeyo-githubb-repo"
                                                    target="_blank" rel='noopener'>
                                                    <h6 style="font-size: 16px;" data-hover="codedeyo-githubb-repo..">
                                                        codedeyo-githubb-repo..</h6>
                                                </a>
                                                <p>Showcase user repositories with a shortcode...</p><a
                                                    href="https://github.com/adeleyeayodeji/codedeyo-githubb-repo/archive/master.zip"
                                                    class="float-left"
                                                    style="border: 1px solid #222;border: 1px solid #222;padding: 5px;margin-top: 20px;color: white;">Download
                                                    <span class="mbri-save text-bold"
                                                        style="color: #ba0d84;margin-left: 8px;"></span></a>
                                    ...
                                    <center>
                                        <div class="col-lg-12" id="loadmore" style="display: none;">
                                            <a class="button slide-vertical ajax-popup-link" data-splitting
                                                href="moregit.php">View All Gits</a>
                                        </div>
                                    </center>
                                </div>
                                <!-- end service items -->
                    ...
                    <div id="contact" class="contact_wrapper">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-12">
                                ...
                                <div class="contact_item">
                                    <h5>Email</h5>
                                    <p><a href="mail:contact@adeleyeayodeji.com" target="_blank"
                                            rel='noopener'>contact@adeleyeayodeji.com</a></p>
                                </div>
                            </div>
                                ...
                                <form id="contact-form" action="mail.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <input class="input_field required" id="name" type="text" name="name"
                                                placeholder="Name">
                                            <!-- input field for EMAIL -->
                                            <input class="input_field required" id="email" type="email" name="email"
                                                placeholder="Email">
                                        </div>
                                        <div class="col-md-7">
                                            <!-- input field for MESSAGE -->
                                            <textarea class="input_field required" id="message" name="message"
                                                placeholder="Tell Me About Your Query."></textarea>
                                        </div>
                                    </div>
                    ...
                    <footer>
                        ...
                        <ul class="social_links">
                            <li><a href="https://www.facebook.com/adeleyeayodeji.code" target="_blank"
                                    rel='noopener'><span class="ion-social-facebook"></span></a></li>
                            <li><a href="https://www.google.com/maps/place/Adeleye+Ayodeji/@6.6741407,3.265471,15z/data=!4m5!3m4!1s0x0:0x92f667b3cd4a9b05!8m2!3d6.6741407!4d3.265471"
                                    target="_blank" rel='noopener'><span class="ion-social-google"></span></a></li>
                            <li><a href="https://twitter.com/adeleyeayodeji_" target="_blank" rel='noopener'><span
                                        class="ion-social-twitter"></span></a></li>
                            <li><a href="https://www.instagram.com/adeleyeayodeji.code/" target="_blank"
                                    rel='noopener'><span class="ion-social-instagram-outline"></span></a></li>
                            <li><a href="https://www.linkedin.com/in/adeleye-ayodeji-69a927158/" target="_blank"
                                    rel='noopener'><span class="ion-social-linkedin"></span></a></li>
                        </ul>
        ...
        <!-- Floating chat -->
        <a href="https://api.whatsapp.com/send?phone=2347034803384&amp;text=Hello%20Adeleye%20Ayodeji,%20your%20service%20is%20requested."
